System.register(['angular2/core', 'angular2/router', './finding.service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, router_2, finding_service_1;
    ...
    return {
        ...
        execute: function() {
            FindingOneComponent = (function () {
                function FindingOneComponent(_routeParams, findingService) {
                    this._routeParams = _routeParams;
                    this.findingService = findingService;
                }
                FindingOneComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    var id = +this._routeParams.get('id');
                    this.findingService.getFinding(id)
                        .subscribe(function (finding) { return _this.finding = finding; });
                ...
                FindingOneComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [router_2.RouteParams, finding_service_1.FindingService])
                ], FindingOneComponent);
